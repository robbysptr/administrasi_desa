...
<div class="row">
   ...
   <?php echo form_open('datawarga/edit/'.$datawarga['nik'], array("enctype" => 'multipart/form-data')); ?>
   <div class="box-body">
    <div class="row clearfix">
     ...
     <div class="col-md-12">
   		...
   		<div class="form-group">
   			<input type="radio" name="jenis_kelamin" value="Laki" <?php if($datawarga['jenis_kelamin']=='Laki'){echo "checked";} ?>/>Laki-laki<br/>
        <input type="radio" name="jenis_kelamin" value="Perempuan" <?php if($datawarga['jenis_kelamin']=='Perempuan'){echo "checked";} ?>/>Perempuan<br/>
    ...
    <div class="col-md-12">
     ...
     <div class="col-md-12">
      ...
      <div class="form-group">
       <input type="date" name="tanggal_lahir" value="<?php echo ($this->input->post('tanggal_lahir') ? $this->input->post('tanggal_lahir') : $datawarga['tanggal_lahir']); ?>" class="form-control" id="tanggal_lahir" />
