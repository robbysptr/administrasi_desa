    ...
    <div class="row clearfix">
     <div class="col-md-12">
      ...
      <div class="form-group">
       <input type="text" disabled name="data_warga" required value="<?php echo ($this->input->post('data_warga') ? $this->input->post('data_warga') : $laporan['data_warga']); ?>" class="form-control" id="data_warga" />
